...
static int compareReversion(string& version1, int first1, int last1,
    string& version2, int first2, int last2);

static bool allZero(string& version, int offset);

int compareVersion_r(string version1, string version2)
{
    int result = 0;
